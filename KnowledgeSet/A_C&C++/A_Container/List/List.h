...
/*****************************************************************************/
/*****************************************************************************/
inline void DL_List_Reset(DL_List *List);
inline void DL_Node_Reset(DL_Node *Node);
inline DL_Node * DL_List_GetHead(DL_List *List);
inline DL_Node * DL_List_GetTail(DL_List *List);
inline DL_Node * DL_Node_GetPrev(DL_Node *Node);
inline DL_Node * DL_Node_GetNext(DL_Node *Node);
/*****************************************************************************/
/*****************************************************************************/
/*****************************************************************************/
...
#define DL_List_Traverse_Backward(List, Node) \
    for (Node = DL_List_GetHead(List); Node != NULL; Node = DL_Node_GetNext(Node))
/* 向前遍历链表宏 */
#define DL_List_Traverse_Forward(List, Node)  \
    for (Node = DL_List_GetTail(List); Node != NULL; Node = DL_Node_GetPrev(Node))
/*****************************************************************************/
/*****************************************************************************/
/*****************************************************************************/
/* 单向链表 */
...
/*****************************************************************************/
/*****************************************************************************/
inline void SL_List_Reset(SL_List *ListHead, SL_List *ListTail);
inline void SL_Node_Reset(SL_Node *Node);
inline SL_Node * SL_List_GetHead(SL_List *ListHead);
inline SL_Node * SL_List_GetTail(SL_List *ListTail);
inline SL_Node * SL_Node_GetNear(SL_Node *Node);
/*****************************************************************************/
/*****************************************************************************/
/*****************************************************************************/
/* 节点头追加 */
